...
Panel mapping
For a panel-to-file index, see `../FIGURE_MAP.csv`.
...
- `figure_data/` — panel-level CSV inputs used for plotting and traceability (including a small number of panel-specific scored tables).

Extended Data Fig. 2 note
- `EDFig2a_data.csv`, `EDFig2b_data.csv`, and `EDFig2c_data.csv` are per-cluster scored tables used to compute confusion matrices.
